                            ...
                            <ul class="collection" id="flow">
                                @foreach($friendsUpdatings as $friendsUpdating)
                                    <li class="collection-item avatar" style="color: #0C0C0C;margin-bottom:20px;height: auto;min-height: 80px;display: table;width: 1030px " >
                                        ...
                                        @else
                                            <img src="{{URL::asset('/uploads/user_profile/'.$friendsUpdating['user_profile'])}}" class="layui-circle" width="65px" height="65px" style="margin-left: 15px;" onclick='javascrtpt:window.location.href="{{url('user/displayOthersInfo/'.$friendsUpdating['uploader_id'])}}"' >
                                        @endif
