...
@section('content')
		...
		<div class="following" style="margin-bottom: 25px;">
			<div style="float: left;margin-bottom: 40px">
				<p style="font-size: 50px;font-family: 'Source Sans Pro', sans-serif;font-weight: 800;color: #333333;width: 500px;">{{trans('User/displayFollow.1')}}</p>
			</div>
			...
			{{--<div class="search_input" style="width: 400px;float: right;margin-top: 15px;">
				<form style="background-color: #34bf49;border-radius:40px;padding-right: 5px; float: right;">
					...
					<input type="text" placeholder="{{trans('User/displayFollow.5')}}Search With User ID……" style="border: 1px #000;background-color: #fcfcfc;color: #0C0C0C" >
