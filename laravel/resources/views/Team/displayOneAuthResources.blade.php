        ...
        @unless(empty($resources))
            @foreach($resources as $resource)
                @foreach($resource as $item)
                    <div style="width:200px;height:400px;float: left;margin-top: 20px;margin-left: 50px">
                        <div class="card" style="width:200px;height:200px">
                            ...
                            <div class="card-content scroll" style="color: #0C0C0C;font-weight: 600;width: 200px;height: 200px;"   >
                                <span class="card-title" style="color: #0C0C0C;font-weight: 900;font-size: 18px;">{{$item['resourceName']}}</span>
